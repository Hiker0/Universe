...
public class WeatherDemon extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.loadUrl("http://www.weather.com.cn"); //设置默认显示的天气预报信息
        webView.setInitialScale(57*2);  //放网页内容放大4倍
    ...
    private void openUrl(String id){
        ...
        webView.loadUrl("http://www.xnw.com/user/log_in.php?act=do_login&password=123456&account=wangzhenjun%40xnw.com&type=login_info&remember_me=1");   //获取并显示天气预报信息
    }
}
