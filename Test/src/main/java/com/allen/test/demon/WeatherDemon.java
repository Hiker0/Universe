...
public class WeatherDemon extends Activity implements OnClickListener {
    ...
    private void openUrl(String id){
        //webView.loadUrl("http://www.weather.com.cn");
        webView.loadUrl("http://www.xnw.com/user/log_in.php?act=do_login&password=123456&account=wangzhenjun%40xnw.com&type=login_info&remember_me=1");
    }
}
