 ...
 * Original file: I:\\works\\Universe\\Test\\src\\main\\aidl\\com\\android\\internal\\policy\\IKeyguardService.aidl
 */
...
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeStrongBinder((((callback!=null))?(callback.asBinder()):(null)));
mRemote.transact(Stub.TRANSACTION_addStateMonitorCallback, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
@Override public void launchCamera(boolean videoRecord) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(((videoRecord)?(1):(0)));
...
static final int TRANSACTION_addStateMonitorCallback = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_dismiss = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_onDreamingStarted = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_onDreamingStopped = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_onScreenTurnedOff = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_onScreenTurnedOn = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
...
static final int TRANSACTION_setCurrentUser = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_showAssistant = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_dispatch = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_onBootCompleted = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_launchCamera = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_startKeyguardExitAnimation = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_onActivityDrawn = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
}
...
public void launchCamera(boolean videoRecord) throws android.os.RemoteException;
/**
     * Notifies that the activity behind has now been drawn and it's safe to remove the wallpaper
     * and keyguard flag.
     *
